...
function get_country_option_icon(country_code, { flags })
{
	if (flags === false)
	{
		return undefined
	...
	// let flagsImg = require(`images/flags/4x3/${country_code.toLowerCase()}.svg`);
	return <img className="react-phone-number-input__icon" src={require(`images/flags/4x3/${country_code.toLowerCase()}.svg`)} />
}
